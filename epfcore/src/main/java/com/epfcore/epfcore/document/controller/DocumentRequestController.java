...
public class DocumentRequestController {
    ...
    public DocumentRequestController(DocumentRequestService documentRequestService, GenerationCertificateService generationCertificateService) {
    ...
    // GET /api/document-requests/student/{studentId}
    ...
    // GET /api/document-requests/status/{status}
    ...
    // GET /api/document-requests/student/{studentId}/status/{status}
    ...
    @GetMapping("/{requestId}/generate/certificate")
    public ResponseEntity<byte[]> generateCertificate(@PathVariable Integer requestId) {
        byte[] pdf = generationCertificateService.generateFromRequest(requestId);
